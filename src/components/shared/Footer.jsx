            ...
            <div className="flex flex-col md:flex-row justify-between items-center px-6 md:px-10 py-16 max-w-[1120px] mx-auto gap-6">
                <div className="flex flex-col items-center md:items-start gap-4">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-2xl text-primary">Voz &amp; Vida</span>
                    </div>
                ...
                <div className="flex flex-wrap justify-center gap-8">
                    <a className="font-semibold text-on-surface-variant hover:text-secondary underline transition-all" href="#servicios">Servicios</a>
                    <a className="font-semibold text-on-surface-variant hover:text-secondary underline transition-all" href="#beneficios">Sobre</a>
                    <a className="font-semibold text-on-surface-variant hover:text-secondary underline transition-all" href="#contacto">Contacto</a>
                </div>
